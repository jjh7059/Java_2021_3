...
public class StringApp {
	public static void main(String[] args) {
		...
		//String.compareToIgnoreCase(String s) - 대소문자 구분X
		if(str1.compareTo(str4) > 0) {
			System.out.println("str1에 저장된 문자열이 str4에 저장된 문자열보다 큽니다.");
		} else if(str1.compareTo(str4) == 0) {
			System.out.println("str1에 저장된 문자열이 str4에 저장된 문자열보다 같습니다.");
		} else {
			System.out.println("str1에 저장된 문자열이 str4에 저장된 문자열보다 작습니다.");
		}
		System.out.println("=====================================================");
		
		//문자열은 내부적으로 byte 배열로 저장되므로 첨자를 이용하여 처리하는 메소드가 존재
		String str5 = "ABCDEFG";
		...
		//String.charAt(int index) : 전닯다은 첨자(Index) 위치의 문자를 반환하는 메소드
		System.out.println("두번째 위치의 문자 = " + str5.charAt(1));
		System.out.println("=====================================================");
		
		//String.indexOf(Stirng str) : 전달된 문자열을 검색하여 저장된 위치의 시작첨자를 반환하는 메소드
		// => 검색된 문자열이 없는 경우 -1 반환
		System.out.println("A 문자의 저장 위치(Index) = " + str5.indexOf("A"));
		System.out.println("EFG 문자의 저장 위치(Index) = " + str5.indexOf("EFG"));
		System.out.println("X 문자의 저장 위치(Index) = " + str5.indexOf("X"));
		System.out.println("=====================================================");
		...
		System.out.println("sty6(대문자) = " + str6.toUpperCase());
		System.out.println("sty6(소문자) = " + str6.toLowerCase());
		System.out.println("=====================================================");
		...
		String str8 = "  임    꺽    정     ";
		//String.replace(String regEx, String replacement) : 저장된 문자열에서 검색 문자열(정규표현식)을
		//찾아 치환 문자열로 변경하여 반환하는 메소드
		...
		//String.substring(int beginIndex, int endIndex) : 저장된 문자열에서 시작첨자(문자포함)부터
		//종료첨자(문자 미포함)까지의 문자열을 분리하여 반환하는 메소드
		...
		//시작첨자만 전달할 경우 시작첨자의 문자부터 문자열의 마지막 문자까지 분리하여 반환
