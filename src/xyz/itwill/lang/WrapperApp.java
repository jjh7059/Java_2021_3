...
//Wrapper : 원시 데이터 타입의 자료형(Primitive Type)을 클래스로 표현한 자료형
...
public class WrapperApp {
	public static void main(String[] args) {
		...
		*/
		...
		//오토박싱(Auto Boxing) : 원시 데이터 타입의 값을 자동으로 Wrapper 인스턴스로 변환하는 기능
		//오토언박싱(Auto Unboxing) : Wrapper 인스턴스를 자동으로 원시 데이터 타입의 값으로 변환하는 기능
