...
public class ExceptionHandleApp {
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("[메시지]무조건 실행되는 명령");
		}
