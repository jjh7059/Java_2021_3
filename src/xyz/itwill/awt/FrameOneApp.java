...
public class FrameOneApp {
	public static void main(String[] args) {
		...
		//Component.setSize(int width, int height) : 컴퍼넌트의 폭과 높이를 변경하는 메소드
		// => GUI 프로그램에서는 위치 또는 크기 단위로 픽셀 사용
		// => 픽셀(Pixel) : 하나의 색을 출력할 수 있는 점(Dot)
		//f.setSize(300, 400);
		
		//Component.setLocation(int x, int y) ; 컴퍼넌트의 출력위치(x 좌표와 y 좌표) 설정하는 메소드
		...
		// => 컨테이너에 대한 설정은 컨테이너에 부착된 컴퍼넌트에 영향을 줌
		f.setVisible(true);
