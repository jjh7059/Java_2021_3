...
public class PenguinMoveApp extends JFrame{
	...
	public void paint(Graphics g) {
		...
		//Graphics.drawImage(Image image, int x, int y, int width, int heigth, imageObserver observer)
		// => 이미지를 출력하는 메소드
	...
	public class PenguinMoveHandle implements KeyListener {
		...
		public void keyPressed(KeyEvent e) {
			...
			//KeyEvent.getKeyCode() : 이벤트를 발생시킨 키보드의 문자값값을 반환하는 메소드
