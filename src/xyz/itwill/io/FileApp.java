...
public class FileApp {
	public static void main(String[] args) throws IOException {
		...
		//File.isDirectory() : File 인스턴스에 저장된 파일경로가 폴더가 아닌경우
		//false를 반환하고 폴더인경우 true를 반환하는 메소드
		if(fileFive.isDirectory()) {
			...
			for(File file:subFiles) {
				//File.isFile() : File 인스턴스에 저장된 파일경로가 파일이 아닌경우
				//false를 반환하고 폴더인경우 true를 반환하는 메소드
				if(file.isFile()) {
