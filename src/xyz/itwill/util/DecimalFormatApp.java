...
public class DecimalFormatApp {
	public static void main(String[] args) {
		//DecimalFormat(String pattern) : 10진수 정수값에 대한 패턴정보를 전달받아 인스턴스를 생성하는 생성자
		...
		//DecimalFormat.getCurrencyInstance().getInstance() : 기본 패턴정보를 저장한 DecimalFormat 인스턴스를 반환하는 메소드
		// => 문자열 앞에 시스템에서 사용되는 화폐단위가 추가되어 반환
		System.out.println("금액 = " + DecimalFormat.getCurrencyInstance().format(money) + "원");
	}
}
