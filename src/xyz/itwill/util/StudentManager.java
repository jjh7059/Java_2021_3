...
//학생정보 관리 기능(저장, 변경, 삭제, 검색 - CRUD)을 제공하기 위한 클래스
...
public class StudentManager {
	...
	public StudentManager() {
		studentList = new ArrayList<Student>();//포함관계 성립
	}
	...
	private int getStudentIndex(int num) {
		...
		for(int i = 0; i < studentList.size(); i++) {
			//콜렉션 필드에 저장된 요소(학생정보)의 학번 전달된 학번을 비교하여 같은 경우
	...
	//학번를 전달받아 콜렉션 필드의 요소를 삭제하고 삭제 결과를 반환하는 메소드
	// => false : 미삭제, true : 삭제
	...
	//학번를 전달받아 콜렉션 필드의 요소 검색하여 요소값(학생정보) 반환하는 메소드
